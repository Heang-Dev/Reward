...
const Hero = () => {
  ...
  return (
    <div className="relative w-screen overflow-x-hidden h-dvh">
      ...
      <div
        id="video-frame"
        className="relative z-10 w-screen overflow-x-hidden rounded-lg h-dvh bg-blue-75"
      >
        <div className="absolute z-50 overflow-hidden rounded-lg cursor-pointer mask-clip-path absolute-center size-64">
          <div
            onClick={handleMiniVdClick}
            className="transition-all duration-500 ease-in origin-center scale-50 opacity-0 hover:opacity-100"
          >
            <video
              ref={nextVideoRef}
